...
public AudioSource sound ;
 public Transform secondGun ;
    ...
    void MakeAHole(CircleCollider2D col)
    {
        ...
        if (GameObject.Find("kim").GetComponent<Wormy>().currentGun == currentGun){
                
                GameObject e = Instantiate(explo) as GameObject;
                e.transform.position = col.bounds.center;
                explo = Explosion ;
        }else 
        if (GameObject.Find("kim").GetComponent<Wormy>().currentGun == secondGun){
                explo = Explosion1 ;
                GameObject e = Instantiate(explo) as GameObject;
                e.transform.position = col.bounds.center;
                explo = Explosion ;
        }else if (GameObject.Find("kim").GetComponent<Wormy>().currentGun == thirdGun){
                explo = Explosion2 ;
                GameObject e = Instantiate(explo) as GameObject;
                e.transform.position = col.bounds.center;
                explo = Explosion ;
            }else if (GameObject.Find("kim").GetComponent<Wormy>().currentGun == fourthdGun){
                explo = Explosion3 ;
                GameObject e = Instantiate(explo) as GameObject;
                e.transform.position = col.bounds.center;
                explo = Explosion ;
              ...
              GameObject debris = Instantiate(debriss) as GameObject;
                debris.transform.position = col.bounds.center;
